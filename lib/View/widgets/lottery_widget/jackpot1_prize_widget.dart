...
Widget jackpot1PrizeWidget(BuildContext context) {
  return GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: lotteryViewModel.lotteryModel.jackpot1Winner > 0
            ? Colors.transparent
            : null,
        boxShadow: lotteryViewModel.lotteryModel.jackpot1Winner > 0
            ? [
                BoxShadow(
      ...
      child: Column(
        children: [
          ...
          Text(
            "${(lotteryViewModel.lotteryModel.prize1Value).toStringAsFixed(0).replaceAllMapped(
