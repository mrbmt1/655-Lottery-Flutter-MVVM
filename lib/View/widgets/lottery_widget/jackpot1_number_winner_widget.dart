...
Widget numberWinnerJackpot1() {
  return Column(children: [
    ...
    Text(
      "Số người trúng: ${lotteryViewModel.lotteryModel.jackpot1Winner}",
      style: TextStyle(
        fontSize: 20,
        color: lotteryViewModel.lotteryModel.jackpot1Winner > 0
            ? Colors.yellow // Đổi màu nếu có người trúng
    ...
    Text(
      "${(lotteryViewModel.lotteryModel.jackpot1Prize).toStringAsFixed(0).replaceAllMapped(
