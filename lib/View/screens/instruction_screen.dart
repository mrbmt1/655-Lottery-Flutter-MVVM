...
class _InstructionScreenState extends State<InstructionScreen> {
  bool _lottoScreen = false;
  bool _checkingScreen = false;
  bool _chartScreen = false;
  bool _predictionScreen = false;
  bool _checkingAllScreen = false;

  bool _hidelottoScreen = true;
  bool _hidecheckingScreen = true;
  bool _hidechartScreen = true;
  bool _hidepredictionScreen = true;
  bool _hidecheckingAllScreen = true;
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            _hidelottoScreen = !_hidelottoScreen;
                            _lottoScreen = !_lottoScreen;
                          });
                        },
                        child: Row(
                          children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: InteractiveViewer(
                              child:
                                  Image.asset('assets/images/Lotto Screen.png'),
                            ),
                          ),
                          const Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            _hidecheckingScreen = !_hidecheckingScreen;
                            _checkingScreen = !_checkingScreen;
                          });
                        },
                        child: Row(
                          children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 20, vertical: 10),
                    child: Visibility(
                      visible: _checkingScreen,
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 50),
                            child: InteractiveViewer(
                              child: Image.asset('assets/images/checking.jpg'),
                            ),
                          ),
                          const Padding(
                            padding: EdgeInsets.all(0),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            _hidechartScreen = !_hidechartScreen;
                            _chartScreen = !_chartScreen;
                          });
                        },
                        child: Row(
                          children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            _hidepredictionScreen = !_hidepredictionScreen;
                            _predictionScreen = !_predictionScreen;
                          });
                        },
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    _hidepredictionScreen =
                                        !_hidepredictionScreen;
                                    _predictionScreen = !_predictionScreen;
                                  });
                                },
                                child: _hidepredictionScreen
                                    ? const Icon(Icons.zoom_out_map,
                                        color: Colors.white)
                                    : const Icon(Icons.minimize,
                                        color: Colors.white),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            _hidecheckingAllScreen = !_hidecheckingAllScreen;
                            _checkingAllScreen = !_checkingAllScreen;
                          });
                        },
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    _hidecheckingAllScreen =
                                        !_hidecheckingAllScreen;
                                    _checkingAllScreen = !_checkingAllScreen;
                                  });
                                },
                                child: _hidecheckingAllScreen
                                    ? const Icon(Icons.zoom_out_map,
                                        color: Colors.white)
                                    : const Icon(Icons.minimize,
                                        color: Colors.white),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: InteractiveViewer(
                              child:
                                  Image.asset('assets/images/checking_all.jpg'),
                            ),
                          ),
                          const Padding(
                            padding: EdgeInsets.all(0),
